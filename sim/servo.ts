...
// Use runtime document via globalThis to avoid TypeScript DOM lib references.
const __doc = (globalThis as any).document;

namespace pxsim.visuals {
    function createServoSVG(): any {
        const SVG_NS = "http://www.w3.org/2000/svg";
        const svg = __doc.createElementNS(SVG_NS, "svg");
        svg.setAttribute("width", "100");
        svg.setAttribute("height", "120");
        svg.setAttribute("viewBox", "0 0 100 120");

        const body = __doc.createElementNS(SVG_NS, "rect");
        ...
        const label = __doc.createElementNS(SVG_NS, "text");
        ...
        const shaft = __doc.createElementNS(SVG_NS, "circle");
        ...
        const hornGroup = __doc.createElementNS(SVG_NS, "g");
        hornGroup.setAttribute("id", "servo-horn");
        hornGroup.setAttribute("transform", "rotate(90 50 50)");

        const hornBar = __doc.createElementNS(SVG_NS, "rect");
        ...
        const hornTip = __doc.createElementNS(SVG_NS, "circle");
        ...
        const makeText = (x: number, y: number, text: string, color = "#666") => {
            const t = __doc.createElementNS(SVG_NS, "text");
        ...
        const makePin = (cx: number, cy: number, color = "#000") => {
            const c = __doc.createElementNS(SVG_NS, "circle");
    ...
    export function mkServoPartSvg(xy: any = [0, 0]): any {
        try {
            ...
            const placeholder = __doc.createElement("div");
